...
class LoginViewController: UIViewController {
    ...
    private let termsButton : UIButton = {
        let button =  UIButton()
        button.setTitle("Terms of Servic", for: .normal)
    ...
    private let privacyButton : UIButton = {
        let button = UIButton()
        button.setTitle("Privaciy Policy", for: .normal)
        button.setTitleColor(.secondaryLabel, for: .normal)
    ...
    private let headerView : UIView = {
        ...
        let bacgroundImageView = UIImageView(image: UIImage(named: "InstagramGradent"))
        header.addSubview(bacgroundImageView)
        return header
    }()
    ...
    override func viewDidLoad() {
        ...
        createAccounButton.addTarget(self, action: #selector(didTapCreateAccountButton), for: .touchUpInside)
    ...
    override func viewDidLayoutSubviews() {
        ...
        createAccounButton.frame = CGRect(
            x: 25,
    ...
    private func addSubviews() {
        ...
        view.addSubview(createAccounButton)
